     ...
     <div class="row">
         ...
         <div class="col-md-6">
             ...
             <div class="form-group">
                 ...
                 <textarea name="question[en]" id="summernote" cols="5" rows="5" class="form-control"></textarea>
         ...
         <div class="col-md-6">
             ...
             <div class="form-group">
                 ...
                 <textarea name="question[az]" id="summernote" cols="5" rows="5" class="form-control"></textarea>
               ...
               <div class="form-group">
                   ...
                   @for($i=1;$i<16;$i++)
                       <label class="radio-inline">
                           <input type="radio" value="{{$i}}" name="level" @if($i == 1) checked @endif >{{$i}}
                       </label>
                   @endfor
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="correct" name='correct[en]' class="form-control" value="{{old('correct.en')}}">
          ...
          <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="correct" name='wrong1[en]' class="form-control" value="{{old('wrong1.en')}}">
        ...
        <div class="row">
           ...
           <div class="col-md-6">
               <div class="form-group">
                   ...
                   <input type="correct" name='wrong2[en]' class="form-control" value="{{old('wrong2.en')}}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="correct" name='wrong3[en]' class="form-control" value="{{old('wrong3.en')}}" >
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label style="color: green;" for="correct">Correct Answer</label>
                    <input type="correct" name='correct[az]' class="form-control" value="{{old('correct.az')}}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name='wrong1[az]' class="form-control" value="{{ old('wrong1.az')}}">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="correct" name='wrong2[az]' class="form-control" value="{{old('wrong2.az')}}" >
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="correct" name='wrong3[az]' class="form-control" value="{{old('wrong3.az')}}">
